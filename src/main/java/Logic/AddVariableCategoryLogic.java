...
public class AddVariableCategoryLogic {
	public boolean addVariableCategory(int userId, String name, int budget)
		...
		try {
			...
			result = categoryDAO.insertVariableCategoryCategories(userId, name, budget);
