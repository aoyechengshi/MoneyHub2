...
import Logic.AddIncomeCategoryLogic;
...
public class AddIncomeCategoryAction implements ActionIF {
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
          ...
          //パラメーターの取得
            ...
            //追加
            AddIncomeCategoryLogic addIncomeCategoryLogic = new AddIncomeCategoryLogic();
            addIncomeCategoryLogic.addIncomeCategory(userId, category);
            //表示用
