...
import Logic.UpdateExpenseLogic;
import entity.Category;
import entity.Expenses;
import entity.Income;

public class UpdeteExpenseAction implements ActionIF{
	 ...
	 @Override
	    public String execute(HttpServletRequest request) {
	        ...
	        try {
				...
				UpdateExpenseLogic updateExpneseLogic = new UpdateExpenseLogic();
				ArrayList<Expenses>  expenseList = updateExpneseLogic.updeteExpense(expenseId, amount, date, memo, userId);
