...
import Logic.RecordIncomeLogic;
...
public class RecordIncomeAction implements ActionIF {
	...
	public String execute(HttpServletRequest request) {
		...
		try {
			...
			String incomeCategoryParam = request.getParameter("incomeCategoryId");
			String incomeAmountParam = request.getParameter("incomeAmount");
			String incomeDateStr = request.getParameter("incomeDate");
			String note = request.getParameter("note");

			int incomeCategoryId = Integer.parseInt(incomeCategoryParam);
			int incomeAmount = Integer.parseInt(incomeAmountParam);
			java.sql.Date incomeDate = java.sql.Date.valueOf(incomeDateStr);

			RecordIncomeLogic recordIncomeLogic = new RecordIncomeLogic();
			recordIncomeLogic.RecordIncome(incomeCategoryId, userId, incomeAmount, note, incomeDate);
