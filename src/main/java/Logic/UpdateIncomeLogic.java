...
public class UpdateIncomeLogic {

	public ArrayList<Income> updateIncome(int incomeId, int userId, int amount, String note, java.sql.Date date) throws UserBusinessException, UserSystemException {
		Connection con = null;
		...
		try {
			...
			incomeDAO.updateIncome(incomeId, userId, amount, note, date);
