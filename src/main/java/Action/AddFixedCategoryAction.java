...
import Logic.AddFixedCategoryLogic;
...
public class AddFixedCategoryAction implements ActionIF {
	...
	public String execute(HttpServletRequest request) {
		...
		try {
			...
			AddFixedCategoryLogic logic = new AddFixedCategoryLogic();
			logic.addFixedCategory(userId, name, budget);
